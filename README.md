...
| Variación Sueldos / Variación Conceptos | Compara el Tabulado del período actual contra el del período anterior del mismo cliente y muestra la variación por empleado: sueldos (899999 + 1000) y premios (2517, 2519). Reusa el Tabulado del mes anterior si ese mes ya se corrió. Solo Plastic Omnium Florida |
