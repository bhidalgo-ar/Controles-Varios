...
| 3.15 | **Familia de Novedades — N2: novedades vs liquidación (B2b)** | **1** | L | Importador validado vs Tabulado + Totales de Concepto, por legajo+código, consolidando los dos lados. Cantidad e importe cuando ambos existen; lo no comparable informa, no bloquea (D-069). Piloto: SIASA y Merz; volumen: POP. Depende de N0a+N0b+N1. Primer caso de verificación: el empleado que en SIASA Aguas y Gaseosas 07/2026 está en la planilla del cliente y no llegó al importador |
