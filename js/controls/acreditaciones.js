 ...
 * única lista de columnas de este export (D-049). No se copian acá: si alguien
 ...
 * arma su `.xlsx` **a mano**, por diseño y no por deuda (D-049): la separación
...
export function buildAcreditacionesWorkbook(results) {
  ...
  const addDetailSheet = (name, title, rows) => {
    ...
    // `writeContractSheet` (D-049). Los anchos, formatos y la fila de título de
