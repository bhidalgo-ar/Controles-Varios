...
## Familia de Novedades (Axton) — N0a construido, faltan N0b, N1 y N2
...
- Próximo paso: seguir con los 3 chats que faltan — N0b (paralelizable con N1), N1, N2 — con los prompts, modelo y esfuerzo ya escritos en `docs/prompts-familia-novedades.md`. Antes de N1, correr el lector contra una planilla real de SIASA o de Merz y confirmar que la reconoce. De Willy: abrir en el navegador las planillas bloqueadas por etiqueta de confidencialidad (Epiroc, Red Bull, POP templates) y preguntar a la analista de SIASA por el empleado que quedó fuera del importador en Aguas y Gaseosas.
