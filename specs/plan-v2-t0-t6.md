...
| **Evals** | Método: prueba de extremo a extremo (Playwright, corre en CI) con el seed de T3 importado. Criterio: al entrar a Marval aparece F.1359 en "Aplican"; al entrar a un cliente sin ese atributo, F.1359 aparece en "Otros controles" pero sigue siendo seleccionable. Revisa: el agente reporta en español llano; el usuario confirma con el CI en verde. |
